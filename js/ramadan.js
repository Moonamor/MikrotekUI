...
var target_date = new Date('May, 6, 2019').getTime();
...
setInterval(function () {
    ...
    countdown.innerHTML = 'باقي لـ رمضان ' + days + ' يوماً و ' +hours+ ' ساعة و ' +minutes+' دقيقة و '+seconds+'ثانية';  
 
}, 1000);
	
	function initWork() {
		var changeDay = document.getElementById("changeDay").innerHTML;
		changeDay = parseInt(changeDay);
		var todayElement = document.getElementById("today");
		var fulldate = (new Date().getDate()+changeDay)+"/"+(new Date().getMonth()+1)+"/"+new Date().getFullYear();
		var date = HijriJS.toHijri(fulldate, "/").toFormat("dd/mm/yyyy");
		var subst = date.substring(0, 5);
		
		if (subst.substring(3, 5) == "09"){
		var zero = subst.substring(0, 2);
		if (zero.substring(0,1) == "0") {
		todayElement.innerHTML = subst.substring(1,2);
		} else {
		todayElement.innerHTML = subst.substring(0,2);
		}
		//var days = subst.substring(0, 2);
		//var word = " رمضان "
		var monthElement = document.getElementById("month");monthElement.innerHTML = " رمضان ";
		};
